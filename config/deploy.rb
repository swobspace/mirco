...
append :linked_files, 'config/database.yml', 'config/mirco.yml', 'config/Passengerfile.json', 'tmp/restart.txt', 'config/puml-theme-mirco.puml'

# Default value for linked_dirs is []
# append :linked_dirs, "log", "tmp/pids", "tmp/cache", "tmp/sockets", "public/system"

append :linked_dirs, 'log', 'files', 'storage', 'tmp/pids', 'tmp/cache', 'tmp/sockets', 'vendor/bundle', 'public/system',
