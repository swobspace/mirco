...
ActiveRecord::Schema.define(version: 20_211_121_102_731) do
  ...
  create_table 'channel_statistics', force: :cascade do |t|
    ...
    t.index %w[channel_id meta_data_id], name: 'index_channel_statistics_on_channel_id_and_meta_data_id',
                                         unique: true
