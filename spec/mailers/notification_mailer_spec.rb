...
RSpec.describe NotificationMailer, type: :mailer do
  ...
  it "renders the header" do
    ...
    expect(mail.subject).to eq("Recovery for #{alert.alertable.fullname}")
  ...
  it "renders the body" do
    ...
    expect(mail.text_part.body.to_s).to match("Type: recovery")
    ...
    expect(sanitize(mail.html_part.body.decoded, tags: [])).to match("Type: recovery")
