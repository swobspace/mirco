  ...
  RSpec.describe ChannelsController, type: :routing do
    describe "routing" do
      ...
      it "routes to #fetch_all" do
        expect(post: "/servers/88/channels/fetch_all", server_id: "88").to route_to("servers/channels#fetch_all", server_id: "88")
      end
      ...
      it "routes to #destroy" do
        expect(delete: "/servers/88/channels/1", server_id: "88").to route_to("servers/channels#destroy", id: "1", server_id: "88")
      end
    end
  end
end
